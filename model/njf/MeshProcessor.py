...
from model.njf.PoissonSystem import poisson_system_matrices_from_mesh, PoissonSystemMatrices, SparseMat
import os
import trimesh
...
class MeshProcessor:
    ...
    def __init__(self, vertices, faces, ttype, from_file=False,
        ...
        self.normals = vertices[:, :, 3:].squeeze().detach().cpu().numpy() #vertices[:, :, 3:].squeeze().detach().cpu().numpy() #igl.per_vertex_normals(self.vertices, self.faces)
        ...
        #self.source_dir = "/media/tbesnier/T5 EVO/datasets/cache"
