...
def read_data(args):
    ...
    reference = trimesh.load('/home/federico/Scrivania/ST/Data/Biwi_6/templates/F1.obj', process=False)
    template_tri = reference.faces
    ...
    reference = trimesh.load('/home/federico/Scrivania/ST/Data/Multiface/templates/20180227.ply', process=False)
    template_tri = reference.faces
    ...
    for r, ds, fs in os.walk(audio_path_multiface):
        for f in tqdm(fs):
            if f.endswith("wav"):
                ...
                subject_id = key.split("_")[0]
                temp = trimesh.load(os.path.join(args.template_file_multiface, subject_id + '.ply'), process=False).vertices
                data[key]["template"] = temp
