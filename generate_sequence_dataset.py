...
for audio in os.listdir(audio_path):
    ...
    if os.path.exists(os.path.join(data_path, sentence)):
        ...
        np.save('/home/federico/Scrivania/ScanTalk/ScanTalk/Dataset/Sequences/seq' + str(j).zfill(3) + '.npy', vertices)
        np.save('/home/federico/Scrivania/ScanTalk/ScanTalk/Dataset/Audios/seq' + str(j).zfill(3) + '.npy', hidden_states)
        np.save('/home/federico/Scrivania/ScanTalk/ScanTalk/Dataset/Templates/seq' + str(j).zfill(3) + '.npy', template)
        j+=1
