...
def main():
    ...
    parser.add_argument("--vertices_path", type=str, default="../datasets/VOCA_training/data_verts.npy")
    parser.add_argument("--vertices_npy_path", type=str, default="../datasets/VOCA_training/data_verts")
    parser.add_argument("--vertices_dim", type=int, default=5023*3)
    parser.add_argument("--raw_audio_path", type=str, default='../datasets/VOCA_training/raw_audio_fixed.pkl')
    parser.add_argument("--wav_path", type=str, default='../datasets/VOCA_training/wav')
    parser.add_argument("--data2array_verts_path", type=str, default='../datasets/VOCA_training/subj_seq_to_idx.pkl')
