...
def read_data(args):
    ...
    vertices_path_voca, vertices_path_multiface = args.vertices_path_voca, args.vertices_path_multiface
    ...
    reference = trimesh.load('/media/tbesnier/T5 EVO/datasets/Face/BIWI/data/templates/F1.obj', process=False)
    template_tri = reference.faces
    ...
    reference = trimesh.load('/media/tbesnier/T5 EVO/datasets/Face/multiface/Aligned_with_VOCA/templates/20180227.ply', process=False)
    template_tri = reference.faces
