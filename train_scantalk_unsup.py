...
def train(args):
    ...
    criterion = Chamfer_Loss(args)#Varifold_loss(args) #nn.MSELoss()
    criterion_val = Chamfer_Loss(args)
...
def main():
    ...
    parser.add_argument("--reference_mesh_file", type=str,
                        default='./template/flame_model/FLAME_sample.ply')#"/media/tbesnier/T5 EVO/datasets/Face/VOCA_SCANS_DS_ALIGNED/templates/FaceTalk_170725_00137_TA.ply")#default='./template/flame_model/FLAME_sample.ply')#'./template/flame_model/FLAME_sample.ply',
    ...
    parser.add_argument("--train_subjects", type=str, default="FaceTalk_170725_00137_TA FaceTalk_170904_00128_TA FaceTalk_170915_00223_TA"
                                                              " FaceTalk_170811_03274_TA FaceTalk_170913_03279_TA FaceTalk_170728_03272_TA"
                                                              " FaceTalk_170904_03276_TA FaceTalk_170912_03278_TA FaceTalk_170811_03275_TA")
    parser.add_argument("--val_subjects", type=str, default="FaceTalk_170725_00137_TA") #"FaceTalk_170728_03272_TA FaceTalk_170811_03275_TA"
                                                            #" FaceTalk_170908_03277_TA")
    parser.add_argument("--test_subjects", type=str, default="FaceTalk_170809_00138_TA"
                                                             " FaceTalk_170731_00024_TA")
    parser.add_argument("--wav_path", type=str, default="/media/tbesnier/T5 EVO/datasets/Face/VOCA_training/wav",
                        help='path of the audio signals')
    parser.add_argument("--vertices_path", type=str,
                        default="/media/tbesnier/T5 EVO/datasets/Face/VOCA_training/vertices_npy",
                        help='path of the ground truth')
    parser.add_argument("--faces_path", type=str,
                        default="/media/tbesnier/T5 EVO/datasets/Face/VOCA_remeshed_npy_faces",
                        help='path of the ground truth')
    parser.add_argument("--template_dir", type=str,
                        default="/media/tbesnier/T5 EVO/datasets/Face/VOCA_training/templates",
                        help='path of the template files')
    parser.add_argument("--load_model", type=bool, default=False)
    parser.add_argument("--model_path", type=str,
                        default='../Data/VOCA/res/Results_Actor/Models/results/ScanTalk_VOCA_REMESHED_CHAMFER.pth.tar')
