...
if __name__ == '__main__':
    ...
    meshes_dir = '/home/federico/Scrivania/ST/Data/Demo_audio_french_female_26s/Meshes'
    l_mesh_dir = len(os.listdir(meshes_dir))
    meshes = [tri.load(os.path.join(meshes_dir, 'tst' + str(i).zfill(3) + '.ply')) for i in range(0, l_mesh_dir)]
